"""
Airplane validation — TUSS single-class airplane separator, both airplane classifiers.

Tests the TUSS single-class airplane checkpoint (20260316_212340) with:
...
SEP_CHECKPOINT = str(
    PROJECT_ROOT / "src/models/tuss/checkpoints/20260316_212340/best_model.pt"
)
...
SNR_RANGE = (-5, 5)
SEED = 42
OUTPUT_DIR = "./tuss_singleclass_airplane_results"
SAVE_EXAMPLES_DIR = "./tuss_singleclass_airplane_examples"
...
def main():
    print("=" * 70)
    print("AIRPLANE VALIDATION — TUSS SINGLE-CLASS AIRPLANE, BOTH CLASSIFIERS")
    print("=" * 70)
    print(f"Separator: TUSS single-class airplane (20260316_212340)")
    ...
    print("\n" + "=" * 70)
    print("RESULTS — TUSS SINGLE-CLASS AIRPLANE, BOTH CLASSIFIERS")
    print("=" * 70)
