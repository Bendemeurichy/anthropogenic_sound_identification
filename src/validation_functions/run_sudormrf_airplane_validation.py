"""
Airplane validation — SuDoRM-RF separator, both airplane classifiers.

Tests the SuDoRM-RF separator with:
...
# Use the multi-COI dataset CSV (same airplane/bird split used across all runs)
DATA_CSV = str(
...
SNR_RANGE = (-5, 5)
SEED = 42
OUTPUT_DIR = "./sudormrf_airplane_results"
SAVE_EXAMPLES_DIR = "./sudormrf_airplane_examples"
...
def main():
    print("=" * 70)
    print("AIRPLANE VALIDATION — SuDoRM-RF SEPARATOR, BOTH CLASSIFIERS")
    print("=" * 70)
    print(f"Separator: SuDoRM-RF ({SEP_CHECKPOINT})")
    ...
    print("\n" + "=" * 70)
    print("RESULTS — SuDoRM-RF, BOTH CLASSIFIERS")
    print("=" * 70)
