"""Main entry point for AST plane classifier training"""
...
def main():
    """Main training function for AST plane classifier"""
    
    parser = argparse.ArgumentParser(description="Train AST plane classifier")
    parser.add_argument(
        '--config',
        type=str,
    ...
    print("="*70)
    print("AST PLANE CLASSIFIER TRAINING")
    print("="*70)
    ...
    # Omit birdset dataset (AST might not handle flacs easily without extra config)
