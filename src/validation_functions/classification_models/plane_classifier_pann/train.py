...
def compute_optimal_threshold(
    model: PlaneClassifierPANN, val_loader: DataLoader, device: str, metric: str = "f1"
...
def train_phase(
    ...
    print(f"\n{'='*70}")
    print(
        f"{phase_name.upper()}: {'TRAINING CLASSIFIER HEAD (CNN14 frozen)' if is_phase1 else 'FINE-TUNING ENTIRE MODEL'}"
    )
    print(f"{'='*70}")
