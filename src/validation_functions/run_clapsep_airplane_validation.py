"""
Airplane validation — CLAPSep separator, both airplane classifiers.

Tests the CLAPSep separator with:
...
SNR_RANGE = (-5, 5)
SEED = 42
OUTPUT_DIR = "./clapsep_airplane_results"
SAVE_EXAMPLES_DIR = "./clapsep_airplane_examples"
...
def main():
    ...
    print("\n" + "=" * 70)
    print("RESULTS — CLAPSep, BOTH CLASSIFIERS")
    print("=" * 70)
