...
This is used to compare the multi-class TUSS bird head against the single-class baseline.
...
SNR_RANGE = (-5, 5)
SEED = 42
OUTPUT_DIR = "./tuss_multiclass_bird_results"
SAVE_EXAMPLES_DIR = "./tuss_multiclass_bird_examples"
...
def main():
    ...
    print("\n" + "=" * 70)
    print("RESULTS — TUSS MULTI-CLASS (bird head), BOTH CLASSIFIERS")
    print("=" * 70)
